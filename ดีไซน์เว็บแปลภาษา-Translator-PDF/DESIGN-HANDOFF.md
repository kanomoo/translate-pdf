# b8669640-35bd-4941-9f52-ed6a0925dcfc implementation handoff

This archive is the source of truth for turning the design into production code. Start from `translator-pdf-prototype.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `translator-pdf-prototype.html`
...
- A single self-contained `translator-pdf-prototype.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `translator-pdf-prototype.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
1. Inspect `translator-pdf-prototype.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
